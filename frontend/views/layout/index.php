...
?>
<div class="main-page">
    <form action="" method="post" class="needs-validation find-form" novalidate>
        <span>Для кого вы ищите:</span>
        <br/>
    ...
    <div class="card" style="width: 18rem;">
        <img class="image-of-object" src="source/images/1.jpg" alt="Card image cap">
        <div class="card-body">
            <h3 class="card-title">Название</h3>
            <p class="card-text">Адрес</p>
            <p class="card-text">Метро</p>
            <p class="card-text">Телефон</p>
            <p class="card-text">Категории</p>
            <p class="card-text">Ключевые слова</p>
        </div>
    </div>
